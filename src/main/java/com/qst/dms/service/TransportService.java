...
public class TransportService {
    ...
    public void saveAndAppendMatchedTransport(ArrayList<MatchedTransport> matchTrans) {
        ...
        // TODO Fix the jar can not find the file problem
        File file = new File("data/MatchedTransports.txt");
        try {
    ...
    public ArrayList<MatchedTransport> readMatchedTransport() {
        ...
        InputStream resourceAsStream = this.getClass().getClassLoader().getResourceAsStream("data/MatchedTransports.txt");
...
//                        receive.getHandler(),receive.getReciver(),
//                        receive.getTransportType()};
//                int recieveKey = db.executeSQLAndReturnPrimaryKey(sql, param);
//                receive.setId(recieveKey);
